 ...
 * segment's byte array is shared the segment may not be recycled, nor may its byte data be
 * changed.
 * The lone exception is that the owner segment is allowed to append to the segment, writing data
 * at
