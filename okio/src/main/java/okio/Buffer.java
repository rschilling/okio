...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    /**
     * Returns true if the range within this buffer starting at {@code segmentPos} in {@code
     * segment}
    ...
    /**
     * Returns an immutable copy of the first {@code byteCount} bytes of this buffer as a byte
     * string.
     */
