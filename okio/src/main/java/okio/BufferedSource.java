...
public interface BufferedSource extends Source {
    ...
    /**
     * Returns true if there are no more bytes in this source. This will block until there are
     * bytes
     ...
     * {@link java.io.EOFException} if the source is exhausted before the required bytes can be
     * read.
     */
     ...
     * }</pre>
     *
     * @throws NumberFormatException if the found digits do not fit into a {@code long} or a
     *                               decimal
    ...
    /**
     * Removes exactly {@code byteCount} bytes from this and appends them to {@code sink}. Throws
     * an
    ...
    /**
     * Removes all bytes from this and appends them to {@code sink}. Returns the total number of
     * bytes
    ...
    /**
     * Removes all bytes from this, decodes them as UTF-8, and returns the string. Returns the
     * empty
     ...
     * break is assumed. Null is returned once the source is exhausted. Use this for
     * human-generated
     ...
     *
     * <p>If this source is exhausted before a complete code point can be read, this throws an
     * {@link
     ...
     * (beyond the 0x10ffff limit of Unicode), code points for UTF-16 surrogates (U+d800..U+dfff)
     * and
    ...
    /**
     * Returns the first index in this buffer that is at or after {@code fromIndex} and that
     * contains
